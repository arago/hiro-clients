...
public final class Hiro
{
  /**
   * create a new client
   * NOTE: the client is thread safe and must be reused/shared instead of being recreated all the time
   * @return
   */
   ...
   * NOTE: a tokenprovider is valid for one HIRO client and must not be reused
   * @return
   */
