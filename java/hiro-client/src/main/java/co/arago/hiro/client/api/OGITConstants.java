...
public interface OGITConstants {
    ...
    interface Attributes {
        ...
        String AUTOMATION_KNOWLEDGEITEMFORMALREPRESENTATION = NAMESPACE_AUTOMATION
                + "knowledgeItemFormalRepresentation";
        ...
        // MARS
        String MARS_NETWORK_FQDN = NAMESPACE_MARS + NAMESPACE_SEPERATOR + NAMESPACE_NETWORK + NAMESPACE_SEPERATOR
                + "fqdn";
    ...
    /**
     * defines some free attributes for ogit/Timeseries that have common some common use
     *
     */
